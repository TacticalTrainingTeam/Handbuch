...
\subsubsection{Bereitstellen einer \acf{LZ}}
	...
	\begin{minipage}[t]{1\textwidth}
		\includegraphics[width=\textwidth]{Landezone.jpg}
	\end{minipage}
	...
	\begin{minipage}[t]{1\textwidth}
		\includegraphics[width=\textwidth]{verdeckteLandungamSammelpunktmitDeckung.jpg}
	\end{minipage}

	\begin{minipage}[t]{1\textwidth}
		\includegraphics[width=\textwidth]{BodenLesenausSichtdesPiloten1.jpg}
	\end{minipage}

	\begin{minipage}[t]{1\textwidth}
		\includegraphics[width=\textwidth]{BodenLesenausSichtdesPiloten2.jpg}
	\end{minipage}	
	...
	\begin{minipage}[t]{1\textwidth}
		\includegraphics[width=\textwidth]{AusSichtdesPiloten.jpg}
	\end{minipage}	
...
\subsubsection{Eingeflogen werden}
	\begin{itemize} 
