...
\begin{minipage}[t]{1\textwidth}
	\includegraphics[width=\textwidth]{Karte1.png}
\end{minipage}
...
\begin{minipage}[t]{1\textwidth}
	\includegraphics[width=\textwidth]{Karte2.png}
\end{minipage}
...
\begin{minipage}[t]{1\textwidth}
	\includegraphics[width=\textwidth]{Karte3.png}
\end{minipage}
...
\begin{minipage}[t]{1\textwidth}
	\includegraphics[width=\textwidth]{Karte4.png}
\end{minipage}