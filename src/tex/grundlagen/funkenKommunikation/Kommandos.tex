...
\subsubsection{Zusammenfassung Kommandos}
	\begin{tabular}{p{0.3\linewidth}p{0.65\linewidth}} 
		...
		\midrule
		Deckung! & Beschusssichere Deckung in 20m Umkreis suchen mit Buddy, ansonsten auf den Boden legen.\\
		...
		Tarnen! & Es ist sofort eine Position zu beziehen, von der aus der Soldat vom Feind nicht gesehen werden kann.\\
