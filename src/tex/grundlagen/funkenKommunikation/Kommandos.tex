...
\paragraph*{Kommando: <<Unterdrückungsfeuer!>>}\hfil\\
...
\paragraph*{Kommando <<Feuerfreigabe erteilt>>}\hfil\\
	Grundsätzliche Freigabe das eigenständig zu eröffnen. Das heißt, sobald Gegner in Sicht sind und der Feuerkampf ist aussichtsreich, darf geschossen werden. Dies gilt bis zum Widerruf.
...
\paragraph*{Kommando: <<Haltet …!>>}\hfil\\
...
\subsubsection{Zusammenfassung Kommandos}
	\begin{longtable}{p{0.3\linewidth}p{0.65\linewidth}} 
		...
		\midrule
		Deckung! & Beschusssichere Objekt in 20\,m Umkreis suchen mit Buddy, ansonsten auf den Boden legen.\\
		...
		Bezieht Stellung bei ... ! & Mit Trupp oder Buddy zu einer Position gehen und entsprechende Sicherung aufbauen.\\
		Wechselt die Stellung! & Mit Trupp oder Buddy oder alleine in andere Stellung verlegen. Auch: \glqq Stellungswechsel nach ...\grqq\\
		Nehmt ... ein! & Das angegebene Ziel ist unter allen Umständen zu erobern und zu sichern.\\
