...
Der Stack ist die Sammelformation vor dem Abmarsch und als Bewegungsformation beim Einstieg in Fahrzeuge. Zudem dient er als Formation für den direkten Zugriff in Räume (siehe \nameref{CQB}). Grundsätzlich wird der Stack in den klassischen (engen) <<Stack>> und <<Stack weit>> unterteilt. Beim <<Stack weit>> werden die Abstände lediglich erweitert.
\begin{figure}[h]
	\centering
...
\begin{figure}[h]
	\centering
	\subfigure[Kolonne]{\includegraphics[width=0.49\linewidth]{./img/grundlagen/formationen/kolonne_4mann}}
	\subfigure[Buddy-Kolonne]{\includegraphics[width=0.49\linewidth]{./img/grundlagen/formationen/kolonne_6mann}}
	\label{fig:Kolonne}
\end{figure}
