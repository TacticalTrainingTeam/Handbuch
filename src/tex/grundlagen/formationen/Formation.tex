...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=15cm]{Stack.png}
...
\begin{minipage}[t]{1\textwidth}
	\includegraphics[width=13cm]{Kolonne.png}
	\label{Kolonne}
\end{minipage}
\begin{minipage}[t]{1\textwidth}
	\includegraphics[width=13cm]{Buddykolonne.png}
\end{minipage}
...
\begin{minipage}[t]{1\textwidth}
	\includegraphics[width=13cm]{Schuetzenkette1.png}
\end{minipage}
\begin{minipage}[t]{1\textwidth}
	\includegraphics[width=13cm]{Schuetzenkette2.png}
\end{minipage}