...
\begin{minipage}[t]{1\textwidth}
	\includegraphics[width=\textwidth]{./Grafiken/KarteUndMarkierungen/Karte2.png}
\end{minipage}
...
\begin{minipage}[t]{1\textwidth}
	\includegraphics[width=\textwidth]{./Grafiken/KarteUndMarkierungen/Karte3.png}
\end{minipage}
...
\begin{minipage}[t]{1\textwidth}
	\includegraphics[width=\textwidth]{./Grafiken/KarteUndMarkierungen/Karte4.png}
\end{minipage}