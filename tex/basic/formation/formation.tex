...
\begin{figure}[h]
	\centering
	\subfigure[Kolonne]{\includegraphics[width=0.49\linewidth]{../img/basic/formation/kolonne_4mann}}
	\subfigure[Buddy-Kolonne]{\includegraphics[width=0.49\linewidth]{../img/basic/formation/kolonne_6mann}}
	\label{fig:Kolonne}
\end{figure}
